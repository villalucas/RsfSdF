...
\hypertarget{mpu__armv8_8h_source}{}\label{mpu__armv8_8h_source}\index{C:/Users/lucas/OneDrive/Documents/GitHub/RsfSdF/STM32/cmsis/core/mpu\_armv8.h@{C:/Users/lucas/OneDrive/Documents/GitHub/RsfSdF/STM32/cmsis/core/mpu\_armv8.h}}
...
\DoxyCodeLine{00111\ \ \ \ \ }
\DoxyCodeLine{00115\ \_\_STATIC\_INLINE\ \textcolor{keywordtype}{void}\ ARM\_MPU\_Enable(uint32\_t\ MPU\_Control)}
\DoxyCodeLine{00116\ \{}
...
\DoxyCodeLine{00123\ \}}
\DoxyCodeLine{00124\ }
\DoxyCodeLine{00127\ \_\_STATIC\_INLINE\ \textcolor{keywordtype}{void}\ ARM\_MPU\_Disable(\textcolor{keywordtype}{void})}
\DoxyCodeLine{00128\ \{}
...
\DoxyCodeLine{00141\ \_\_STATIC\_INLINE\ \textcolor{keywordtype}{void}\ ARM\_MPU\_Enable\_NS(uint32\_t\ MPU\_Control)}
\DoxyCodeLine{00142\ \{}
...
\DoxyCodeLine{00149\ \}}
\DoxyCodeLine{00150\ }
\DoxyCodeLine{00153\ \_\_STATIC\_INLINE\ \textcolor{keywordtype}{void}\ ARM\_MPU\_Disable\_NS(\textcolor{keywordtype}{void})}
\DoxyCodeLine{00154\ \{}
...
\DoxyCodeLine{00163\ }
\DoxyCodeLine{00169\ \_\_STATIC\_INLINE\ \textcolor{keywordtype}{void}\ ARM\_MPU\_SetMemAttrEx(MPU\_Type*\ mpu,\ uint8\_t\ idx,\ uint8\_t\ attr)}
\DoxyCodeLine{00170\ \{}
...
\DoxyCodeLine{00180\ \}}
\DoxyCodeLine{00181\ }
\DoxyCodeLine{00186\ \_\_STATIC\_INLINE\ \textcolor{keywordtype}{void}\ ARM\_MPU\_SetMemAttr(uint8\_t\ idx,\ uint8\_t\ attr)}
\DoxyCodeLine{00187\ \{}
\DoxyCodeLine{00188\ \ \ ARM\_MPU\_SetMemAttrEx(MPU,\ idx,\ attr);}
\DoxyCodeLine{00189\ \}}
\DoxyCodeLine{00190\ }
\DoxyCodeLine{00191\ \textcolor{preprocessor}{\#ifdef\ MPU\_NS}}
\DoxyCodeLine{00196\ \_\_STATIC\_INLINE\ \textcolor{keywordtype}{void}\ ARM\_MPU\_SetMemAttr\_NS(uint8\_t\ idx,\ uint8\_t\ attr)}
\DoxyCodeLine{00197\ \{}
\DoxyCodeLine{00198\ \ \ ARM\_MPU\_SetMemAttrEx(MPU\_NS,\ idx,\ attr);}
\DoxyCodeLine{00199\ \}}
\DoxyCodeLine{00200\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00201\ }
\DoxyCodeLine{00206\ \_\_STATIC\_INLINE\ \textcolor{keywordtype}{void}\ ARM\_MPU\_ClrRegionEx(MPU\_Type*\ mpu,\ uint32\_t\ rnr)}
\DoxyCodeLine{00207\ \{}
...
\DoxyCodeLine{00216\ \{}
\DoxyCodeLine{00217\ \ \ ARM\_MPU\_ClrRegionEx(MPU,\ rnr);}
\DoxyCodeLine{00218\ \}}
\DoxyCodeLine{00219\ }
\DoxyCodeLine{00220\ \textcolor{preprocessor}{\#ifdef\ MPU\_NS}}
\DoxyCodeLine{00224\ \_\_STATIC\_INLINE\ \textcolor{keywordtype}{void}\ ARM\_MPU\_ClrRegion\_NS(uint32\_t\ rnr)}
\DoxyCodeLine{00225\ \{\ \ }
\DoxyCodeLine{00226\ \ \ ARM\_MPU\_ClrRegionEx(MPU\_NS,\ rnr);}
\DoxyCodeLine{00227\ \}}
\DoxyCodeLine{00228\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00229\ }
\DoxyCodeLine{00236\ \_\_STATIC\_INLINE\ \textcolor{keywordtype}{void}\ ARM\_MPU\_SetRegionEx(MPU\_Type*\ mpu,\ uint32\_t\ rnr,\ uint32\_t\ rbar,\ uint32\_t\ rlar)}
\DoxyCodeLine{00237\ \{}
...
\DoxyCodeLine{00241\ \}}
\DoxyCodeLine{00242\ }
\DoxyCodeLine{00248\ \_\_STATIC\_INLINE\ \textcolor{keywordtype}{void}\ ARM\_MPU\_SetRegion(uint32\_t\ rnr,\ uint32\_t\ rbar,\ uint32\_t\ rlar)}
\DoxyCodeLine{00249\ \{}
\DoxyCodeLine{00250\ \ \ ARM\_MPU\_SetRegionEx(MPU,\ rnr,\ rbar,\ rlar);}
\DoxyCodeLine{00251\ \}}
\DoxyCodeLine{00252\ }
\DoxyCodeLine{00253\ \textcolor{preprocessor}{\#ifdef\ MPU\_NS}}
\DoxyCodeLine{00259\ \_\_STATIC\_INLINE\ \textcolor{keywordtype}{void}\ ARM\_MPU\_SetRegion\_NS(uint32\_t\ rnr,\ uint32\_t\ rbar,\ uint32\_t\ rlar)}
\DoxyCodeLine{00260\ \{}
\DoxyCodeLine{00261\ \ \ ARM\_MPU\_SetRegionEx(MPU\_NS,\ rnr,\ rbar,\ rlar);\ \ }
\DoxyCodeLine{00262\ \}}
\DoxyCodeLine{00263\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00264\ }
\DoxyCodeLine{00270\ \_\_STATIC\_INLINE\ \textcolor{keywordtype}{void}\ orderedCpy(\textcolor{keyword}{volatile}\ uint32\_t*\ dst,\ \textcolor{keyword}{const}\ uint32\_t*\ \_\_RESTRICT\ src,\ uint32\_t\ len)}
\DoxyCodeLine{00271\ \{}
...
\DoxyCodeLine{00277\ \}}
\DoxyCodeLine{00278\ }
\DoxyCodeLine{00285\ \_\_STATIC\_INLINE\ \textcolor{keywordtype}{void}\ ARM\_MPU\_LoadEx(MPU\_Type*\ mpu,\ uint32\_t\ rnr,\ \mbox{\hyperlink{struct_a_r_m___m_p_u___region__t}{ARM\_MPU\_Region\_t}}\ \textcolor{keyword}{const}*\ table,\ uint32\_t\ cnt)\ }
\DoxyCodeLine{00286\ \{}
...
\DoxyCodeLine{00290\ \ \ \ \ orderedCpy(\&(mpu-\/>RBAR),\ \&(table-\/>\mbox{\hyperlink{struct_a_r_m___m_p_u___region__t_afe7a7721aa08988d915670efa432cdd2}{RBAR}}),\ rowWordSize);}
...
\DoxyCodeLine{00298\ \ \ \ \ \ \ orderedCpy(\&(mpu-\/>RBAR)+(rnrOffset*2U),\ \&(table-\/>\mbox{\hyperlink{struct_a_r_m___m_p_u___region__t_afe7a7721aa08988d915670efa432cdd2}{RBAR}}),\ c*rowWordSize);}
...
\DoxyCodeLine{00304\ \ \ \ \ \}}
\DoxyCodeLine{00305\ \ \ \ \ }
\DoxyCodeLine{00306\ \ \ \ \ orderedCpy(\&(mpu-\/>RBAR)+(rnrOffset*2U),\ \&(table-\/>\mbox{\hyperlink{struct_a_r_m___m_p_u___region__t_afe7a7721aa08988d915670efa432cdd2}{RBAR}}),\ cnt*rowWordSize);}
\DoxyCodeLine{00307\ \ \ \}}
\DoxyCodeLine{00308\ \}}
\DoxyCodeLine{00309\ }
\DoxyCodeLine{00315\ \_\_STATIC\_INLINE\ \textcolor{keywordtype}{void}\ ARM\_MPU\_Load(uint32\_t\ rnr,\ \mbox{\hyperlink{struct_a_r_m___m_p_u___region__t}{ARM\_MPU\_Region\_t}}\ \textcolor{keyword}{const}*\ table,\ uint32\_t\ cnt)\ }
\DoxyCodeLine{00316\ \{}
\DoxyCodeLine{00317\ \ \ ARM\_MPU\_LoadEx(MPU,\ rnr,\ table,\ cnt);}
\DoxyCodeLine{00318\ \}}
\DoxyCodeLine{00319\ }
\DoxyCodeLine{00320\ \textcolor{preprocessor}{\#ifdef\ MPU\_NS}}
\DoxyCodeLine{00326\ \_\_STATIC\_INLINE\ \textcolor{keywordtype}{void}\ ARM\_MPU\_Load\_NS(uint32\_t\ rnr,\ \mbox{\hyperlink{struct_a_r_m___m_p_u___region__t}{ARM\_MPU\_Region\_t}}\ \textcolor{keyword}{const}*\ table,\ uint32\_t\ cnt)\ }
\DoxyCodeLine{00327\ \{}
\DoxyCodeLine{00328\ \ \ ARM\_MPU\_LoadEx(MPU\_NS,\ rnr,\ table,\ cnt);}
\DoxyCodeLine{00329\ \}}
